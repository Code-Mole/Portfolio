...
const HeroSection = () => {
  ...
  return (
    <section id="hereSection" className="mt-28">
      <div className="h-screen bg-gray-100 shadow-lg rounded-lg  flex flex-col gap-14 md:flex-row items-center justify-center text-center">
      <div><h1 className="text-4xl sm:text-6xl font-bold text-gray-900">Hi,I`m Asanga Emmanuel</h1>
      <p className="mt-4 text-3xl font-light"> A <span className=" text-4xl text-indigo-500">{professions[currentProfession]}</span></p>
