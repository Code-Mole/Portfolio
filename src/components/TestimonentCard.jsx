...
function TestimonentCard({testimonial}) {
  return (
    <div className="bg-white dark:bg-slate-700 p-6 rounded-lg shadow-md hover:shadow-slate-500">
    <div className="flex items-center space-x-4">
      <img src={testimonial.avatar} alt={testimonial.name} className="w-12 h-12 rounded-full dark:text-slate-300" />
      <div>
